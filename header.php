...
<?php $stylesheet = auto_version('styles/main.css'); ?>
<link href="<?php echo $stylesheet; ?>" rel="stylesheet" type="text/css" />
<style type="text/css">
<?php if ($wide)  { ?> #page_content img{max-width:920px!important;}</style><?php } ?>
	<?php 
...
<?php echo stripcslashes($sa_settings['sa_custom_css']); ?>
</style>
<?php } ?>
