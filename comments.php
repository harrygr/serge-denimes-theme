...
'cancel_reply_link'    => __( '<span class="cancel_reply">Cancel reply</span>' ),
...
<ol class="commentlist"><?php wp_list_comments($largs); ?></ol>
	...
	<?php $args = array(
  'prev_text' => __('<span class="nav_arrow">&laquo;</span> Previous'),
  'next_text' => __('Next <span class="nav_arrow">&raquo;</span>')
); ?>
