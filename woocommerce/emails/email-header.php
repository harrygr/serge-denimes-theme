...
<html>
    <head>
		...
		<style type="text/css">
			...
			body {
				background-color: <?php echo get_option('woocommerce_email_background_color'); ?>;
			}
    ...
    <body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" style="background-color: <?php echo get_option('woocommerce_email_background_color'); ?>;">
