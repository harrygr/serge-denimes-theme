...
<a class="middlerowimages" href="<?php echo $sa_settings['sa_home_url3']; ?>" title="<?php echo $sa_settings['sa_home_text3']; ?>">
	<img id="l-homethumb" class="wide-homethumb" title="<?php echo $sa_settings['sa_home_text3']; ?>" src="<?php echo $sa_settings['sa_home_image3']; ?>" alt="<?php echo $sa_settings['sa_home_text3']; ?>" height="210" width="471">
	<p class="wide-home_text"><?php echo $sa_settings['sa_home_text3']; ?></p>
</a>
<?php } else { ?>
<a class="middlerowimages" href="<?php echo $sa_settings['sa_home_url3b']; ?>" title="<?php echo $sa_settings['sa_home_text3b']; ?>">
	<img id="l-homethumb" class="wide-homethumb" title="<?php echo $sa_settings['sa_home_text3b']; ?>" src="<?php echo $sa_settings['sa_home_image3b']; ?>" alt="<?php echo $sa_settings['sa_home_text3b']; ?>" height="210" width="471">
	<p class="wide-home_text"><?php echo $sa_settings['sa_home_text3b']; ?></p>
</a>
<?php } wp_reset_query(); ?>
